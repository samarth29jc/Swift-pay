 ...
 * @property {function} [onOpenChange] - Callback when the toast open state changes
 */

/**
 * @param {ToastProps} props - The toast props
 * @returns {Object} The toast object with id, dismiss and update methods
 */
